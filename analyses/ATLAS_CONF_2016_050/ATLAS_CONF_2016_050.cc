///
/// @file  ATLAS_CONF_2016_050.cc
/// @brief Implementation of ATLAS_CONF_2016_050 analysis
/// @author Kazuki
...
namespace Atom {
    ...
    class ATLAS_CONF_2016_050 : public Analysis {
    public:

        ATLAS_CONF_2016_050()
            : Analysis("ATLAS_CONF_2016_050") {
    ...
    AtomPlugin(ATLAS_CONF_2016_050)
}
