///
/// @file  ATLAS_CONF_2016_076.cc
/// @brief Implementation of ATLAS_CONF_2016_076 analysis
/// @author Kazuki
...
namespace Atom {
    ...
    class ATLAS_CONF_2016_076 : public Analysis {
    public:

        ATLAS_CONF_2016_076()
            : Analysis("ATLAS_CONF_2016_076") {
    ...
    AtomPlugin(ATLAS_CONF_2016_076)
}
