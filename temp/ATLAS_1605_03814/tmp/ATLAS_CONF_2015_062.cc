///
/// @file  ATLAS_CONF_2015_062.cc
/// @brief Implementation of ATLAS_CONF_2015_062 analysis
/// @author Kazuki Sakurai <kazuki.sakurai@durham.ac.uk>
/// @date created 02/15/2016
/// @date last revision 02/15/2016
///
...
namespace Atom {
	...
	class ATLAS_CONF_2015_062 : public Analysis {
	public:

		ATLAS_CONF_2015_062()
			: Analysis("ATLAS_CONF_2015_062") {
		...
		void analyze(const Event& event) {
            ...
            // 5j
            if( jets.size() > 4){
                if( cut( jets[4].pT(), CUT_GT, 100., "pTj5 > 100: 5j" ) ){
            ...
            // 6jm
            if( jets.size() > 5){
                if( cut( jets[5].pT(), CUT_GT, 100., "pTj6 > 100: 6jm" ) ){
            ...
            // 6jt
            if( jets.size() > 5){
                if( cut( jets[5].pT(), CUT_GT, 100., "pTj6 > 100: 6jt" ) ){
	...
	AtomPlugin(ATLAS_CONF_2015_062)
}
